...
{for(var i = 0, len = gdjs.Question_322Code.GDNewTextObjects1.length ;i < len;++i) {
    ...
    gdjs.Question_322Code.GDTimerObjects1[i].setString("Time: " + gdjs.evtTools.common.toString(Math.floor(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().getFromIndex(0)) / 60)));
}
