...
{gdjs.playerAuthentication.displayAuthenticationBanner(runtimeScene);
    ...
    gdjs.Question_321Code.GDNewTextObjects1[i].setString("PLAYING");
}
}{for(var i = 0, len = gdjs.Question_321Code.GDTimerObjects1.length ;i < len;++i) {
    gdjs.Question_321Code.GDTimerObjects1[i].setString("Time: " + gdjs.evtTools.common.toString(Math.floor(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("Time")) / 60)));
}
